...
public class Menu implements org.apache.thrift.TBase<Menu, Menu._Fields>, java.io.Serializable, Cloneable, Comparable<Menu> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<ItemOrNull> items; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.ITEMS, new org.apache.thrift.meta_data.FieldMetaData("items", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ItemOrNull.class))));
  ...
  public Menu(
    ...
    java.util.List<ItemOrNull> items)
  {
    this();
    this.header = header;
    this.items = items;
  ...
  public Menu(Menu other) {
    ...
    if (other.isSetItems()) {
      java.util.List<ItemOrNull> __this__items = new java.util.ArrayList<ItemOrNull>(other.items.size());
      for (ItemOrNull other_element : other.items) {
        __this__items.add(new ItemOrNull(other_element));
      }
  ...
  public Menu setHeader(@org.apache.thrift.annotation.Nullable java.lang.String header) {
    this.header = header;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<ItemOrNull> getItemsIterator() {
    return (this.items == null) ? null : this.items.iterator();
  }

  public void addToItems(ItemOrNull elem) {
    if (this.items == null) {
      this.items = new java.util.ArrayList<ItemOrNull>();
    }
    this.items.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<ItemOrNull> getItems() {
    return this.items;
  }

  public Menu setItems(@org.apache.thrift.annotation.Nullable java.util.List<ItemOrNull> items) {
    this.items = items;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ITEMS:
      if (value == null) {
        ...
        setItems((java.util.List<ItemOrNull>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.items = new java.util.ArrayList<ItemOrNull>(_list0.size);
                @org.apache.thrift.annotation.Nullable ItemOrNull _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new ItemOrNull();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Menu struct) throws org.apache.thrift.TException {
      ...
      if (struct.items != null) {
        oprot.writeFieldBegin(ITEMS_FIELD_DESC);
        {
          ...
          for (ItemOrNull _iter3 : struct.items)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class MenuTupleScheme extends org.apache.thrift.scheme.TupleScheme<Menu> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Menu struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.header);
      {
        ...
        for (ItemOrNull _iter4 : struct.items)
        {
          _iter4.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Menu struct) throws org.apache.thrift.TException {
      ...
      struct.setHeaderIsSet(true);
      {
        ...
        struct.items = new java.util.ArrayList<ItemOrNull>(_list5.size);
        @org.apache.thrift.annotation.Nullable ItemOrNull _elem6;
        for (int _i7 = 0; _i7 < _list5.size; ++_i7)
        {
          _elem6 = new ItemOrNull();
          _elem6.read(iprot);
