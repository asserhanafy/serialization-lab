...
public class MenuItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3936040425803959919L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MenuItem\",\"namespace\":\"com.serialization.lab.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"label\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public MenuItem(java.lang.CharSequence id, java.lang.CharSequence label) {
    this.id = id;
    this.label = label;
  }
   ...
   */
  public static com.serialization.lab.avro.MenuItem.Builder newBuilder() {
    return new com.serialization.lab.avro.MenuItem.Builder();
  }
   ...
   * @return A new MenuItem RecordBuilder
   */
  public static com.serialization.lab.avro.MenuItem.Builder newBuilder(com.serialization.lab.avro.MenuItem.Builder other) {
    if (other == null) {
      return new com.serialization.lab.avro.MenuItem.Builder();
    } else {
      return new com.serialization.lab.avro.MenuItem.Builder(other);
    }
  }
   ...
   * @return A new MenuItem RecordBuilder
   */
  public static com.serialization.lab.avro.MenuItem.Builder newBuilder(com.serialization.lab.avro.MenuItem other) {
    if (other == null) {
      return new com.serialization.lab.avro.MenuItem.Builder();
    } else {
      return new com.serialization.lab.avro.MenuItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MenuItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.serialization.lab.avro.MenuItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.serialization.lab.avro.MenuItem other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.serialization.lab.avro.MenuItem.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.serialization.lab.avro.MenuItem.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.serialization.lab.avro.MenuItem.Builder setLabel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.serialization.lab.avro.MenuItem.Builder clearLabel() {
      label = null;
